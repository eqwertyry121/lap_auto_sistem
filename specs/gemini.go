...
Правила:
1. cpu — ТОЛЬКО точная модель. «i5», «i7», «Intel Core», «Ryzen» без номера модели — пустая строка (и заполни why_no_cpu). Серый/чёрный стикер Intel на фото — обычно 10–14 поколение, синий — 4–9.
2. laptop_model — ищи шильдик на дне ноутбука, гравировку на крышке или рамке экрана, наклейки серии. Если видно только семейство (например «EliteBook») без поколения — пиши что видно.
