...
var l1Markers = []l1Marker{
	...
	// Шаблон реселлера Western Europe из trace 2026-08-10: условия связи +
	// витринное описание состояния повторяются на серии объявлений.
	{"bez upisanog broja telefona", 1, "условия связи для покупателей без телефона — шаблон реселлера"},
	{"na poruke putem kupujem prodajem ne odgovaramo", 1, "не отвечают в KP — коммерческий шаблон связи"},
	{"top fabricko stanje", 1, "витринное описание состояния — шаблон реселлера"},
}
