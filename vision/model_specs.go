...
Правила:
1. cpu — ТОЛЬКО точная модель с поколением (i5-1135G7, Ryzen 5 4600H, Ultra 7 155H). Если у модели несколько конфигураций CPU — выбери самую вероятную для этой комплектации.
